...
class WorkflowManager:
    ...
    Attributes:
        ...
        scraper: WebScraper instance for content scraping
        content_processor: GPTContentProcessor for processing scraped content
        embedding_db: Database instance for storing embeddings
        chatbot: FAQBot instance for chat interactions
        _is_initialized: Internal state tracking
    """
    ...
    def is_initialized(self) -> bool:
        """Returns whether the workflow is initialized."""
        return self._is_initialized

    async def initialize_chatbot_only(self) -> None:
        """Initialize only the chatbot using existing database data.
    ...
    async def chat_loop(self) -> None:
        ...
        Raises:
            ChatbotError: If chatbot is not initialized
        """
